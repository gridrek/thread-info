...
- [Thread](#thread)
  - [Thread Device Roles](#thread-device-roles)
    - [1. Router](#1-router)
      - [Routing Responsibilities](#routing-responsibilities)
      - [Joining New Devices](#joining-new-devices)
      - [Always Powered](#always-powered)
    ...
    - [2. Leader](#2-leader)
      ...
      - [Router and Device Management](#router-and-device-management)
      - [Leader Resilience](#leader-resilience)
    - [3. End Device](#3-end-device)
      - [Sleepy End Devices (SED)](#sleepy-end-devices-seds)
      - [Non-Sleepy End Devices (NSED)](#non-sleepy-end-devices-nseds)
    - [4. Child](#4-child)
      - [Parent-Child Dynamics](#parent-child-dynamics)
      - [Re-association](#re-association)
      - [Child Table](#child-table)
    - [5. Border Router](#5-border-router)
      - [Gateway Role](#gateway-role)
      - [Dual Interface](#dual-interface)
      - [Routing Beyond Thread](#routing-beyond-thread)
      - [Multiple Border Routers](#multiple-border-routers)
      - [Security in Border Communication](#security-in-border-communication)
  - [Additional Aspects of Thread Device Roles](#additional-aspects-of-thread-device-roles)
    - [Mesh Network and Role Flexibility](#mesh-network-and-role-flexibility)
      - [Self-Healing Mesh](#self-healing-mesh)
      - [Role Transitioning](#role-transitioning)
    - [Security and Network Integrity](#security-and-network-integrity)
      - [AES-128 Encryption](#aes-128-encryption)
      - [Unique Network Keys](#unique-network-keys)
- [Router role in-depth](#router-role-in-depth)
  - [1. Routing Responsibilities](#1-routing-responsibilities)
    - [Routing Tables](#routing-tables)
    - [Entries in Routing Tables](#entries-in-routing-tables)
    - [Distance Vector Routing](#distance-vector-routing)
    - [Link Metrics](#link-metrics)
  - [Handling Multicast and Unicast Traffic](#handling-multicast-and-unicast-traffic)
  - [Mesh Under vs Mesh Over](#mesh-under-vs-mesh-over)
  - [2. Joining New Devices](#2-joining-new-devices)
    - [Commissioning Process](#commissioning-process)
    - [Joiner Device Role](#joiner-device-role)
    - [Commissioner Role](#commissioner-role)
    - [Secure Messaging](#secure-messaging)
    - [Parent-Child Relationship](#parent-child-relationship-1)
  - [3. Always Powered](#3-always-powered)
    - [Energy Requirements](#energy-requirements)
    - [Comparison to End Devices](#comparison-to-end-devices)
    - [Power Optimization](#power-optimization)
  - [4. Connectivity Management](#4-connectivity-management)
  ...
  - [5. Handling High Device Density](#5-handling-high-device-density)
    - [Scaling with Device Density](#scaling-with-device-density)
    - [Balanced Load](#balanced-load)
  - [6. Traffic Prioritization and QoS (Quality of Service)](#6-traffic-prioritization-and-qos-quality-of-service)
    - [Prioritizing Traffic](#prioritizing-traffic)
    - [Quality of Service (QoS)](#quality-of-service-qos)
  - [7. Redundancy and Failover](#7-redundancy-and-failover)
    - [Multiple Routers and Redundancy](#multiple-routers-and-redundancy)
    - [Router Promotion](#router-promotion)
- [Leader Role in Depth](#leader-role-in-depth)
  - [1. Leader Election Process](#1-leader-election-process)
    - [Dynamic Election](#dynamic-election)
    - [Decentralized and Autonomous](#decentralized-and-autonomous)
    - [Leader Failover](#leader-failover)
    - [Fallback Criteria](#fallback-criteria)
  - [2. Address Assignment](#2-address-assignment)
    ...
    - [6LoWPAN Compression](#6lowpan-compression)
    - [Address Reclamation](#address-reclamation)
  - [3. Router and Device Management](#3-router-and-device-management)
    - [Topology Tracking](#topology-tracking)
    - [Router Tables](#router-tables)
    - [End Device Tracking](#end-device-tracking)
    - [Adding and Removing Routers](#adding-and-removing-routers)
    - [Promoting End Devices to Routers](#promoting-end-devices-to-routers)
    - [Router Downgrade](#router-downgrade)
    - [Monitoring Link Quality](#monitoring-link-quality)
  - [4. Leader Resilience](#4-leader-resilience)
    - [Failover and Re-election Process](#failover-and-re-election-process)
    - [Leadership Stability](#leadership-stability)
    - [Decentralized Fault-Tolerance](#decentralized-fault-tolerance)
    - [Synchronizing State](#synchronizing-state)
  - [5. Network Configuration and Management](#5-network-configuration-and-management)
    - [Global Network Parameters](#global-network-parameters)
    - [Routing and Load Balancing](#routing-and-load-balancing)
  - [6. Communication with Border Routers](#6-communication-with-border-routers)
    - [Border Router Coordination](#border-router-coordination)
    - [Gateway Management](#gateway-management)
- [End Devices in Depth](#end-devices-in-depth)
  - [1. Sleepy End Devices (SEDs)](#1-sleepy-end-devices-seds)
    - [a. Battery-Powered Operation](#a-battery-powered-operation)
    - [b. Parent-Child Relationship](#b-parent-child-relationship)
    - [c. Polling Mechanism](#c-polling-mechanism)
    - [d. Minimal Communication](#d-minimal-communication)
    - [e. Practical Use Cases for SEDs](#e-practical-use-cases-for-seds)
  - [2. Non-Sleepy End Devices (NSEDs)](#2-non-sleepy-end-devices-nseds)
    - [a. Always Powered Operation](#a-always-powered-operation)
    - [b. Direct Communication](#b-direct-communication)
    - [c. Reduced Latency](#c-reduced-latency)
    - [d. Practical Use Cases for NSEDs](#d-practical-use-cases-for-nseds)
  - [3. General End Device Characteristics](#3-general-end-device-characteristics)
    - [a. Simplified Network Role](#a-simplified-network-role)
    - [b. Scalability](#b-scalability)
    - [c. Security](#c-security)
    - [d. Commissioning and Network Joining](#d-commissioning-and-network-joining)
  - [4. End Device Resilience and Redundancy](#4-end-device-resilience-and-redundancy)
    - [a. Handling Parent Router Failure](#a-handling-parent-router-failure)
    - [b. Supporting Roaming Devices](#b-supporting-roaming-devices)
- [Border Router in Thread Networks](#border-router-in-thread-networks)
  - [1. Gateway Role](#1-gateway-role)
    - [Connecting Thread to External Networks](#connecting-thread-to-external-networks)
    - [Example Use Cases](#example-use-cases)
    - [IPv6 Connectivity](#ipv6-connectivity)
    - [Internet Access for Thread Devices](#internet-access-for-thread-devices)
  - [2. Dual Interface](#2-dual-interface)
    - [Support for Multiple Network Interfaces](#support-for-multiple-network-interfaces)
    - [Translation Between Networks](#translation-between-networks)
    - [Example](#example-1)
    - [Interfacing with External Services](#interfacing-with-external-services)
  - [3. Routing Beyond Thread](#3-routing-beyond-thread)
    - [Route Redistribution](#route-redistribution)
    - [Routing Decisions](#routing-decisions)
  - [4. Multiple Border Routers](#4-multiple-border-routers)
    - [Redundancy and Failover](#redundancy-and-failover)
    - [Load Balancing](#load-balancing)
    - [Distributed Border Router Topology](#distributed-border-router-topology)
    - [Dynamic Routing Updates](#dynamic-routing-updates)
    - [Coexistence with Multiple Border Routers](#coexistence-with-multiple-border-routers)
  - [5. Security in Border Communication](#5-security-in-border-communication)
    - [Encryption and Authentication](#encryption-and-authentication)
    - [Firewall and Access Control](#firewall-and-access-control)
    - [Key Distribution and Management](#key-distribution-and-management)
  - [6. Protocol and Application-Level Communication](#6-protocol-and-application-level-communication)
    - [Application Layer Translation](#application-layer-translation)
